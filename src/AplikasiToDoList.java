...
//        System.out.println(result);
    ...
    public static void viewAddToDoList() {
        ...
        var todo = input("todo (x jika batal menambah kegiatan)");
    ...
    public static void viewRemoveToDoList() {
        ...
        var number = input("Kegiatan Yang Ingin Dihapus (x jika batal menghapus kegiatan)");
